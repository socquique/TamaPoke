...
static const Species SPECIES[NUM_SPECIES] = {
  { "CHARMANDER", TYPE_FUEGO, SPR_CHARMANDER, 8, SP_CHARMELEON, 16, 6, 9, 17, 12, 13, 0xF427, 0xEA87 },
  { "CHARMELEON", TYPE_FUEGO, SPR_CHARMELEON, 10, SP_CHARIZARD, 36, 6, 8, 16, 12, 12, 0xEA87, 0xEA87 },
  { "CHARIZARD", TYPE_FUEGO, SPR_CHARIZARD, 12, -1, 0, 6, 10, 18, 12, 14, 0xF427, 0xEA87 },
  { "BULBASAUR", TYPE_PLANTA, SPR_BULBASAUR, 8, SP_IVYSAUR, 16, 10, 6, 13, 16, 9, 0x8EB6, 0x3C49 },
  { "IVYSAUR", TYPE_PLANTA, SPR_IVYSAUR, 10, SP_VENUSAUR, 36, 10, 6, 13, 16, 9, 0x8EB6, 0x3C49 },
  { "VENUSAUR", TYPE_PLANTA, SPR_VENUSAUR, 12, -1, 0, 10, 5, 12, 16, 8, 0x8EB6, 0x3C49 },
  { "SQUIRTLE", TYPE_AGUA, SPR_SQUIRTLE, 8, SP_WARTORTLE, 16, 5, 8, 16, 11, 12, 0x7E3D, 0x4C98 },
  { "WARTORTLE", TYPE_AGUA, SPR_WARTORTLE, 10, SP_BLASTOISE, 36, 6, 7, 15, 12, 11, 0x9D5C, 0x4C98 },
  { "BLASTOISE", TYPE_AGUA, SPR_BLASTOISE, 12, -1, 0, 6, 11, 19, 12, 15, 0x3B74, 0x4C98 },
};
